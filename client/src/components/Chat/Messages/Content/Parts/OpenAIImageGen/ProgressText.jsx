...
export default function ProgressText({ progress, error, toolName = 'image_gen_oai', }) {
    ...
    const text = getText();
    return (<div className={cn('progress-text-content pointer-events-none absolute left-0 top-0 inline-flex w-full items-center gap-2 overflow-visible whitespace-nowrap')}>
