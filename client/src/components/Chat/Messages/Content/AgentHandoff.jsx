...
const AgentHandoff = ({ name, args: _args = '' }) => {
    ...
    return (<div className="my-3">
      <div className={cn('flex items-center gap-2.5 text-sm text-text-secondary', hasInfo && 'cursor-pointer transition-colors hover:text-text-primary')} onClick={() => hasInfo && setShowInfo(!showInfo)}>
      ...
      {hasInfo && showInfo && (<div className="ml-8 mt-2 rounded-md bg-surface-secondary p-3 text-xs">
