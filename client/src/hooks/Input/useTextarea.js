...
export default function useTextarea({ textAreaRef, submitButtonRef, setIsScrollable, disabled = false, }) {
    ...
    const { index, conversation, isSubmitting, filesLoading, latestMessage, setFilesLoading } = useChatContext();
