...
export default function useMessageProcess({ message }) {
    ...
    const handleScroll = useCallback((event) => {
        throttle(() => {
            logger.log('message_scrolling', `useMessageProcess: setting abort scroll to ${isSubmitting}, handleScroll event`, event);
            if (isSubmitting) {
                setAbortScroll(true);
            }
            else {
